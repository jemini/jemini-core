...
describe 'ResourceManager' do
  ...
  describe "#load_resources" do
    ...
    before :each do
      ...
      Java::org::newdawn::slick::Image.stub!(:new).and_return(mock('Image'))
      Java::org::newdawn::slick::Sound.stub!(:new).and_return(mock('Sound'))
      Java::org::newdawn::slick::Music.stub!(:new).and_return(mock('Music'))
    ...
    describe "with global assets" do
      ...
      it "loads assets from global data directory" do
        @resource_manager.base_path = 'test/game_with_global_assets/data'
      ...
      it "raises an error when accessing an asset that doesn't exist" do
        @resource_manager.base_path = 'test/game_with_no_assets/data'
        @resource_manager.load_resources
        lambda{@resource_manager.get_image(:foobar)}.should raise_error
      end
      
      it "loads ini files" do
        @resource_manager.base_path = 'test/game_with_ini/data'
      ...
      it "loads png files" do
        @resource_manager.base_path = 'test/game_with_pngs/data'
        @resource_manager.images.should have(0).images
        @resource_manager.load_resources
        @resource_manager.images.should have(1).image
      end
      ...
      it "loads gif files" do
        @resource_manager.base_path = 'test/game_with_gifs/data'
        @resource_manager.images.should have(0).images
        @resource_manager.load_resources
        @resource_manager.images.should have(1).image
      end
      ...
      it "loads wav files" do
        @resource_manager.base_path = 'test/game_with_wavs/data'
      ...
      it "loads ogg files" do
        @resource_manager.base_path = 'test/game_with_oggs/data'
      ...
      it "warns if multiple formats with the same name are found, but loads one anyway" do
        @resource_manager.base_path = 'test/game_with_duplicate_assets/data'
        @resource_manager.log.should_receive(:warn).with(/duplicate/)
        @resource_manager.load_resources
      end
    
      it "warns if invalid files are found" do
        @resource_manager.base_path = 'test/game_with_unsupported_assets/data'
    ...
    describe "with state-specific assets" do
      ...
      it "loads assets from data subdirectory with same name as current state" do
        ...
        @resource_manager.base_path = 'test/game_with_per_state_assets/data'
        @resource_manager.images.should have(0).images
        @resource_manager.load_resources
        @resource_manager.images.should have(1).image
      end
      ...
      it "does not load global assets with the same name as a state asset" do
        ...
        @resource_manager.base_path = 'test/game_with_overridden_assets/data'
