...
#  i.map_key :released => Input::KEY_SPACE, :spawn_thing => nil
  ...
  i.map_key :held => Input::KEY_LSHIFT, :fire_weapon => nil, :player => 0
  ...
  0.upto i.connected_joystick_size - 1 do |j|
    ...
    i.map_joystick :joystick_id => j, :held => XBOX_360_A, :fire_weapon => nil, :player => j
...
#  end
  ...
  # KEY_TAB doesn't work unless alt+tab. Mac only?
  i.map_key :held => Input::KEY_SPACE, :fire_weapon => nil, :player => 1
